...
describe('Debug Tablebase Flow', () => {
  ...
  it('sollte testen was UnifiedEvaluationService macht', async () => {
    ...
    const { UnifiedEvaluationService } = await import('@shared/lib/chess/evaluation/unifiedService');
    const { EngineProviderAdapter, TablebaseProviderAdapter } = await import('@shared/lib/chess/evaluation/providerAdapters');
    const { LRUCache } = await import('@shared/lib/cache/LRUCache');
    const { LRUCacheAdapter } = await import('@shared/lib/chess/evaluation/cacheAdapter');
