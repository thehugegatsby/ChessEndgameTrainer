 ...
 * Prioritizes objective correctness over engine evaluation nuances
 */
 ...
 * Prioritizes tablebase accuracy over engine evaluation
 */
...
export interface AdaptiveConfig {
  ...
  /** Whether to show engine lines in explanations */
