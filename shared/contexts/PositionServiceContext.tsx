...
import { IPositionService, IPositionServiceConfig } from '@shared/services/database/IPositionService';
 ...
 */
export const PositionServiceProvider: React.FC<PositionServiceProviderProps> = ({
  children,
  repository,
  config
}) => {
 ...
 */
export const usePositionService = (): IPositionService => {
  const context = useContext(PositionServiceContext);
  
  if (!context) {
    throw new Error('usePositionService must be used within PositionServiceProvider');
  }
 ...
 */
export const usePositionRepository = (): IPositionRepository => {
  const context = useContext(PositionServiceContext);
 ...
 */
export function withPositionService<P extends { positionService: IPositionService }>(
