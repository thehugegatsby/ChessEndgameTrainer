...
import { formatPositionTitle, getShortTitle, getTrainingDisplayTitle } from '@shared/utils/titleFormatter';
...
describe('titleFormatter', () => {
  ...
  describe('formatPositionTitle', () => {
    ...
    it('handles rook-pawn category with Brückenbau title', () => {
      const position = { ...brückenbauPosition, category: 'rook-pawn' as const };
