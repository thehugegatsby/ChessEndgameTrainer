  ...
  describe('isValidFen', () => {
    ...
    describe('Invalid FEN Strings', () => {
      ...
      test('should_reject_invalid_castling_rights', () => {
        ...
        expect(isValidFen('rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/RNBQKBNR w Kqq - 0 1')).toBe(false);
      });
    ...
    describe('Edge Cases', () => {
      ...
      test('should_handle_various_en_passant_squares', () => {
        expect(isValidFen('rnbqkbnr/ppp1pppp/8/3p4/4P3/8/PPPP1PPP/RNBQKBNR w KQkq d6 0 2')).toBe(true);
        expect(isValidFen('rnbqkbnr/pppppp1p/8/6p1/4P3/8/PPPP1PPP/RNBQKBNR w KQkq g6 0 2')).toBe(true);
      });
    });
  });
