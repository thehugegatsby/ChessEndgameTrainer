...
import {
  isValidFen,
  validateFen,
} from "../../../../shared/lib/chess/validation";
  ...
  describe("isValidFen", () => {
    ...
    describe("Invalid FEN strings - Format validation", () => {
      it("should reject wrong number of parts", () => {
        expect(isValidFen("rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/RNBQKBNR")).toBe(
          false,
        ); // Missing parts
        expect(
          isValidFen("rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/RNBQKBNR w"),
        ).toBe(false); // Only 2 parts
        expect(
          isValidFen("rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/RNBQKBNR w KQkq"),
        ).toBe(false); // Only 3 parts
        expect(
          isValidFen("rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/RNBQKBNR w KQkq -"),
        ).toBe(false); // Only 4 parts
        expect(
          isValidFen("rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/RNBQKBNR w KQkq - 0"),
        ).toBe(false); // Only 5 parts
        expect(
          isValidFen(
            "rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/RNBQKBNR w KQkq - 0 1 extra",
          ),
        ).toBe(false); // Too many parts
      });
      ...
      it("should reject special characters", () => {
        ...
        ).toBe(false); // Exclamation
        expect(
          isValidFen(
            "rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/RNBQKBNR w KQkq - 0 1@",
          ),
        ).toBe(false); // At symbol
        expect(
          isValidFen(
            "rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/RNBQKBNR w KQkq - 0 1#",
          ),
        ...
        ).toBe(false); // Dollar in en passant
      });
      ...
      it("should reject invalid castling rights", () => {
        ...
        expect(
          isValidFen("rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/RNBQKBNR w KK - 0 1"),
        ).toBe(false); // Duplicate K
        expect(
          isValidFen("rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/RNBQKBNR w QQ - 0 1"),
        ).toBe(false); // Duplicate Q
        expect(
          isValidFen("rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/RNBQKBNR w kk - 0 1"),
        ).toBe(false); // Duplicate k
        expect(
    ...
    describe("Invalid FEN strings - Chess logic validation", () => {
      ...
      it("should reject positions with invalid piece placement", () => {
        expect(
          isValidFen("rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/9 w KQkq - 0 1"),
        ).toBe(false); // Invalid number
        expect(
          isValidFen("rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/ w KQkq - 0 1"),
        ).toBe(false); // Empty rank
      });
      ...
      it("should reject positions with no kings", () => {
        expect(
          isValidFen(
            "rnbqnbnr/pppppppp/8/8/8/8/PPPPPPPP/RNBQNBNR w KQkq - 0 1",
          ),
        ).toBe(false);
      });
    });
    ...
    describe("Edge cases", () => {
      ...
      it("should handle promotion scenarios", () => {
        expect(
          isValidFen("rnbqkbnQ/pppppppp/8/8/8/8/PPPPPPP1/RNBQKBNR b KQq - 0 1"),
        ).toBe(true); // Promoted queen (one pawn missing)
      });

      it("should handle unicode and international characters", () => {
        expect(
          isValidFen(
            "rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/RNBQKBNR w KQkq - 0 1ö",
          ),
        ).toBe(false); // Non-ASCII
        expect(
          isValidFen(
            "rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/RNBQKBNR w KQkq - 0 1€",
          ),
