...
describe('WebStorageService - Migrated Tests', () => {
  ...
  describe('Per-test container approach', () => {
    ...
    test('should save and load data correctly', async () => {
      ...
      TestAssertions.expectStorageCall(mockStorage, 'setItem', 'chess_trainer_test-key', JSON.stringify(testData));
      ...
      TestAssertions.expectStorageCall(mockStorage, 'getItem', 'chess_trainer_test-key');
    });
  ...
  describe('Migration comparison', () => {
    ...
    test('NEW APPROACH (Jest 30 compatible)', async () => {
      ...
      TestAssertions.expectStorageCall(mockStorage, 'setItem', 'chess_trainer_test', '"data"');
    });
  });
});
