...
module.exports = {
  ...
  // Projects configuration for selective testing
  projects: [
    {
      displayName: 'unit',
    ...
    },
    {
      ...
      testMatch: ['<rootDir>/tests/performance/**/*.{spec,test}.[jt]s?(x)'],
      transform: {
        '^.+\\.(ts|tsx|js|jsx)$': ['ts-jest', {
          tsconfig: '<rootDir>/configs/typescript/tsconfig.jest.json'
        }]
    ...
    },
    {
      ...
      testMatch: ['<rootDir>/tests/regression/**/*.{spec,test}.[jt]s?(x)'],
      transform: {
        '^.+\\.(ts|tsx|js|jsx)$': ['ts-jest', {
          tsconfig: '<rootDir>/configs/typescript/tsconfig.jest.json'
        }]
    ...
    {
      displayName: 'smoke',
      testMatch: ['<rootDir>/tests/smoke/**/*.{spec,test}.[jt]s?(x)'],
      transform: {
        '^.+\\.(ts|tsx|js|jsx)$': ['ts-jest', {
          tsconfig: '<rootDir>/configs/typescript/tsconfig.jest.json'
        }]
