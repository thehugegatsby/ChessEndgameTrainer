...
export class PositionFactory {
   ...
   */
  static createEndgame(overrides: Partial<EndgamePosition> = {}): EndgamePosition {
   ...
   */
  static createRookEndgame(overrides: Partial<EndgamePosition> = {}): EndgamePosition {
   ...
   */
  static createPawnEndgame(overrides: Partial<EndgamePosition> = {}): EndgamePosition {
    return this.createEndgame({
   ...
   */
  static fromFEN(fen: string, overrides: Partial<EndgamePosition> = {}): EndgamePosition {
    return this.createEndgame({
      fen,
      ...overrides
    });
