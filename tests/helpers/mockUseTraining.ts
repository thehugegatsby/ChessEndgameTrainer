 ...
 */
export const mockUseTraining = (overrides: MockTrainingState = {}) => {
  ...
  (useTraining as jest.MockedFunction<typeof useTraining>).mockReturnValue(mockState as any);
 ...
 */
export const resetUseTrainingMock = () => {
 ...
 */
export const verifyUseTrainingCalls = (mock: jest.MockedFunction<typeof useTraining>, expectedCalls: number) => {
