...
test.describe.skip(
  'Pawn Promotion Auto-Win (SequenceRunner) - Ready to unskip: Issue #99 resolved',
  () => {
    ...
    test('should handle promotion to different pieces', async ({ page }) => {
      ...
      const rookPromotionSequence = {
        ...
        moves: ['e6-d6', 'e8-f7', 'e5-e6+', 'f7-f6', 'd6-d7', 'f6-e5', 'e6-e7', 'e5-f5', 'e7-e8=R'],
        expectations: [
    ...
    test('should show error for wrong promotion choice', async ({ page }) => {
      ...
      const wrongPromotionSequence = {
        ...
        moves: [
          ...
          'e6-e7',
          'e5-f5',
          'e7-e8=B', // Bishop instead of Queen
        ],
        expectations: [
...
test.describe.skip(
  'Pawn Promotion Edge Cases (SequenceRunner) - Ready to unskip: Issue #99 resolved',
  () => {
    ...
    test("should handle promotion with opponent's immediate capture", async ({ page }) => {
      ...
      const captureScenario = {
        ...
        moves: [
          ...
          'e6-e7',
          'c8-b7',
          'e7-e8=Q', // Queen can be captured but still wins
        ],
        expectations: [
