...
describe("Tablebase Evaluation - Move Quality Display", () => {
  describe("Mate Evaluations", () => {
    test("should_display_mate_in_1_as_excellent", () => {
      const result = getMoveQualityDisplay(0, 1);
    ...
    test("should_display_mate_in_3_as_excellent", () => {
      const result = getMoveQualityDisplay(0, 3);
    ...
    test("should_display_mate_in_15_as_excellent", () => {
      const result = getMoveQualityDisplay(0, 15);
    ...
    test("should_display_being_mated_as_neutral", () => {
      const result = getMoveQualityDisplay(0, -5);
  ...
  describe("Positional Evaluations", () => {
    test("should_display_dominating_position_with_star", () => {
      // >= 5.0 pawns advantage
      const result = getMoveQualityDisplay(5.5, undefined);
    ...
    test("should_display_excellent_position_with_sparkles", () => {
      // >= 2.0 pawns advantage
      const result = getMoveQualityDisplay(3.0, undefined);
    ...
    test("should_display_good_position_with_ok_hand", () => {
      // >= 0.5 pawns advantage
      const result = getMoveQualityDisplay(1.0, undefined);
    ...
    test("should_display_neutral_position_with_circle", () => {
      // Near 0 evaluation
      const result = getMoveQualityDisplay(0.1, undefined);
  ...
  describe("Threshold Tests", () => {
    test("should_handle_exact_5_0_threshold", () => {
      const result = getMoveQualityDisplay(5.0, undefined);
      expect(result.text).toBe("⭐");
    });

    test("should_handle_just_below_5_0_threshold", () => {
      const result = getMoveQualityDisplay(4.99, undefined);
      expect(result.text).toBe("✨");
    });

    test("should_handle_exact_2_0_threshold", () => {
      const result = getMoveQualityDisplay(2.0, undefined);
      expect(result.text).toBe("✨");
    });

    test("should_handle_just_below_2_0_threshold", () => {
      const result = getMoveQualityDisplay(1.99, undefined);
      expect(result.text).toBe("👌");
    });

    test("should_handle_exact_0_5_threshold", () => {
      const result = getMoveQualityDisplay(0.5, undefined);
      expect(result.text).toBe("👌");
    });

    test("should_handle_just_below_0_5_threshold", () => {
      const result = getMoveQualityDisplay(0.49, undefined);
      expect(result.text).toBe("⚪");
    });
  });
  ...
  describe("Absolute Value Handling", () => {
    test("should_use_absolute_value_for_negative_evaluations", () => {
      const negativeResult = getMoveQualityDisplay(-3.0, undefined);
      const positiveResult = getMoveQualityDisplay(3.0, undefined);
  ...
  describe("Edge Cases", () => {
    test("should_handle_very_large_evaluations", () => {
      const result = getMoveQualityDisplay(100.0, undefined);
    ...
    test("should_handle_very_small_evaluations", () => {
      const result = getMoveQualityDisplay(0.01, undefined);
    ...
    test("should_handle_zero_evaluation", () => {
      const result = getMoveQualityDisplay(0.0, undefined);
    ...
    test("should_handle_zero_mate_as_normal_evaluation", () => {
      ...
      const result = getMoveQualityDisplay(1.0, 0);
    ...
    test("should_handle_NaN_gracefully", () => {
      const result = getMoveQualityDisplay(NaN, undefined);
    ...
    test("should_handle_Infinity", () => {
      const result = getMoveQualityDisplay(Infinity, undefined);
  ...
  describe("Legacy Parameter", () => {
    test("should_ignore_isPlayerMove_parameter", () => {
      const withTrue = getMoveQualityDisplay(3.0, undefined);
      const withFalse = getMoveQualityDisplay(3.0, undefined);
