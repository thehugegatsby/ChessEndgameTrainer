...
/**
 * @deprecated Use TEST_POSITIONS instead
 */
export const COMMON_FENS = TEST_POSITIONS;

/**
 * @deprecated Use TEST_POSITIONS instead
 */
export const TEST_FENS = TEST_POSITIONS;

/**
 * @deprecated Use TEST_POSITIONS instead
 */
export const StandardPositions = {
  STARTING: TEST_POSITIONS.STARTING_POSITION,
  CASTLING_AVAILABLE: TEST_POSITIONS.CASTLING_AVAILABLE,
  EN_PASSANT: TEST_POSITIONS.EN_PASSANT_POSITION,
  EN_PASSANT_COMPLEX: TEST_POSITIONS.EN_PASSANT_COMPLEX,
  AFTER_E4: TEST_POSITIONS.OPENING_AFTER_E4,
  AFTER_E4_E5: TEST_POSITIONS.OPENING_AFTER_E4_E5,
} as const;
...
export const SpecialPositions = {
  CHECKMATE: TEST_POSITIONS.CHECKMATE_POSITION,
  STALEMATE: TEST_POSITIONS.STALEMATE_POSITION,
  CHECK: TEST_POSITIONS.CHECK_POSITION,
  BLACK_IN_CHECK: TEST_POSITIONS.BLACK_IN_CHECK,
  INSUFFICIENT_MATERIAL: TEST_POSITIONS.INSUFFICIENT_MATERIAL,
  PROMOTION: TEST_POSITIONS.WHITE_PROMOTION,
} as const;
...
export const EndgamePositions = {
  KPK_BASIC: TEST_POSITIONS.KPK_BASIC_WIN,
  KPK_WHITE_TO_MOVE: TEST_POSITIONS.KPK_WHITE_TO_MOVE,
  KPK_WIN: TEST_POSITIONS.KPK_BASIC_WIN,
  KQK_WIN: TEST_POSITIONS.KQK_WIN,
  KQK_BLACK_TO_MOVE: TEST_POSITIONS.KQK_BLACK_TO_MOVE,
  KK_DRAW: TEST_POSITIONS.KK_DRAW,
  KNK_DRAW: TEST_POSITIONS.KNK_DRAW,
  KPK_CENTRAL: TEST_POSITIONS.KPK_CENTRAL,
  LUCENA: TEST_POSITIONS.LUCENA,
  KPK_VARIANTS: {
    DRAW_POSITION: TEST_POSITIONS.KPK_DRAW_POSITION,
    BLACK_TO_MOVE: TEST_POSITIONS.KPK_BLACK_TO_MOVE,
  },
  REAL_API_KPK: TEST_POSITIONS.REAL_API_KPK,
  EMPTY_BOARD: TEST_POSITIONS.EMPTY_BOARD,
} as const;

/**
 * @deprecated Use TEST_MOVES from individual scenarios instead
 */
...
export function getRandomTestPosition(): string {
  const positions = [
    ...
    TEST_POSITIONS.EN_PASSANT_POSITION,
    TEST_POSITIONS.COMPLEX_MIDDLE_GAME,
    TEST_POSITIONS.INSUFFICIENT_MATERIAL,
  ];
  const index = Math.floor(Math.random() * positions.length);
  return positions[index] || TEST_POSITIONS.STARTING_POSITION;
}
...
export function getRandomEndgamePosition(): string {
  const positions = [
    ...
    TEST_POSITIONS.KPK_WHITE_TO_MOVE,
    TEST_POSITIONS.INSUFFICIENT_MATERIAL,
    TEST_POSITIONS.WHITE_PROMOTION,
  ];
  const index = Math.floor(Math.random() * positions.length);
  return positions[index] || TEST_POSITIONS.KPK_BASIC_WIN;
}
