...
export class WdlAdapter {
   ...
   */
  static convertToPlayerPerspective(
    wdlBefore: RawWdlValue,
    wdlAfter: RawWdlValue
  ): { wdlBeforeFromPlayerPerspective: RawWdlValue; wdlAfterFromPlayerPerspective: RawWdlValue } {
    return {
