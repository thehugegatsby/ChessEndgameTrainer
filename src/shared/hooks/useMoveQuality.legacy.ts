...
// Note: Using dynamic import for service instead of React Query hook
  ...
  const assessMove = useCallback(
    async (
      ...
      try {
        ...
        // Note: Using direct service call as this is a hook and can't use other hooks in callback
        // TODO: Consider refactoring to use React Query pattern with parallel queries
