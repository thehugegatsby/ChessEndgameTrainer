 ...
 * game rules, position handling, and evaluation thresholds. Merged from multiple
 * chess constant files for consistency.
 *
 * @remarks
 ...
 * Merged from src/constants/chess.constants.ts
 */
...
export type SmartEvaluationConstants = typeof SMART_EVALUATION_THRESHOLDS;
export type ResultClassificationConstants = typeof RESULT_CLASSIFICATION;
export type WdlConversionConstants = typeof WDL_CONVERSION;
export type MoveCompletionConstants = typeof MOVE_COMPLETION;
export type EvaluationFormattingConstants = typeof EVALUATION_FORMATTING;
export type PositionAnalysisConstants = typeof POSITION_ANALYSIS;