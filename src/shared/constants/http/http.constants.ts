...
import { HTTP_BUFFER_SIZES } from '../cache';
 ...
 * Merged from api.constants.ts and http.constants.ts
 */
...
export type ApiTimeoutConstants = typeof API_TIMEOUTS;
export type ApiLimitConstants = typeof API_LIMITS;