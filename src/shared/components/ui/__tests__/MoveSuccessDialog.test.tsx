...
describe('MoveSuccessDialog', () => {
  ...
  describe('Rendering', () => {
    ...
    it('shows correct message for Dame promotion', () => {
      ...
      expect(
        screen.getByText('Ausgezeichnet! Umwandlung in Dame führt zum Sieg!')?.isConnected
      ).toBe(true);
    });
    ...
    it('shows correct message for Queen promotion (English)', () => {
      ...
      expect(
        screen.getByText('Ausgezeichnet! Umwandlung in Queen führt zum Sieg!')?.isConnected
      ).toBe(true);
    });
    ...
    it('shows correct message for Turm promotion', () => {
      ...
      expect(screen.getByText('Großartig! Umwandlung in Turm führt zum Sieg!')?.isConnected).toBe(
        true
      );
    });
    ...
    it('shows correct message for Rook promotion (English)', () => {
      ...
      expect(screen.getByText('Großartig! Umwandlung in Rook führt zum Sieg!')?.isConnected).toBe(
        true
      );
    });
    ...
    it('shows correct message for Läufer promotion', () => {
      ...
      expect(screen.getByText('Klug! Umwandlung in Läufer führt zum Sieg!')?.isConnected).toBe(
        true
      );
    });
    ...
    it('shows correct message for Bishop promotion (English)', () => {
      ...
      expect(screen.getByText('Klug! Umwandlung in Bishop führt zum Sieg!')?.isConnected).toBe(
        true
      );
    });
    ...
    it('shows correct message for Springer promotion', () => {
      ...
      expect(screen.getByText('Clever! Umwandlung in Springer führt zum Sieg!')?.isConnected).toBe(
        true
      );
    });
    ...
    it('shows correct message for Knight promotion (English)', () => {
      ...
      expect(screen.getByText('Clever! Umwandlung in Knight führt zum Sieg!')?.isConnected).toBe(
        true
      );
    });
    ...
    it('shows default message for unknown promotion piece', () => {
      ...
      expect(screen.getByText('Perfekt! Umwandlung in Unknown führt zum Sieg!')?.isConnected).toBe(
        true
      );
    });
    ...
    it('shows default message when no promotion piece provided', () => {
      ...
      expect(screen.getByText('Glückwunsch! Die Umwandlung führt zum Sieg!')?.isConnected).toBe(
        true
      );
    });
