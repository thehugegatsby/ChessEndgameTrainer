  ...
  return (
    <div className="space-y-4 h-full overflow-y-auto">
      ...
      <div className="dark-card rounded-lg p-4">
        ...
        >
          Die Opposition ist ein fundamentales Konzept in Bauernendspielen. Der
          Spieler hat die Opposition, wenn sein König dem gegnerischen König
          direkt gegenübersteht mit einem Feld dazwischen.
        </p>
        ...
        <div className="space-y-3">
          ...
          <div>
            ...
            <p className="text-xs" style={{ color: "var(--text-secondary)" }}>
              Ziehe deinen König vorwärts, um Raum zu gewinnen, aber achte
              darauf, die Opposition nicht zu verlieren.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="dark-card rounded-lg p-4">
        ...
        <div className="text-xs" style={{ color: "var(--text-secondary)" }}>
          <p className="mb-2">
            Die Felder d6, e6, f6 sind kritisch für Weiß. Erreicht der weiße
            König eines dieser Felder, ist der Gewinn garantiert.
          </p>
          <div className="grid grid-cols-3 gap-1 text-center">
            <div className="dark-card-elevated p-1 rounded text-xs font-mono">
              d6
            </div>
            <div className="dark-card-elevated p-1 rounded text-xs font-mono">
              e6
