...
describe('TrainingBoard', () => {
  ...
  describe('Rendering', () => {
    it('renders training board wrapper and mock chessboard', () => {
      ...
      renderWithStoreProvider(<TrainingBoard position={position} onComplete={vi.fn()} />);
    ...
    it('renders with draggable pieces when game is not finished', () => {
      renderWithStoreProvider(
        <TrainingBoard position={mockTrainingState.currentPosition!} onComplete={vi.fn()} />
      );
  ...
  describe('Promotion Handling', () => {
    it('handles pawn promotion correctly', async () => {
      ...
      renderWithStoreProvider(<TrainingBoard position={promotionPosition} onComplete={vi.fn()} />);
